    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-emerald-50 relative overflow-hidden text-center">
          <div className="absolute top-0 left-0 size-96 bg-emerald-100/50 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <PolicySection title="1. Eligibility for Returns">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
               <div className="flex gap-3 p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
          ...
          {/* Need Help CTA */}
          <section className="mt-12 p-8 md:p-12 rounded-[40px] bg-emerald-600 text-white text-center relative overflow-hidden shadow-2xl shadow-emerald-500/20">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Button size="lg" className="bg-white text-emerald-600 hover:bg-emerald-50 font-black px-10 py-7 text-lg shadow-xl">
