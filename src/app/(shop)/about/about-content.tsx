        ...
        <section className="relative py-20 bg-primary/5 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-3xl">
              <Badge variant="verified" className="bg-white text-primary border-primary/20 mb-6 py-1.5 px-4 font-bold">
                ESTABLISHED 2024
              </Badge>
              <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight leading-tight mb-8">
                Your Trusted Partner for <span className="text-primary">Premium Solutions</span>
              </h1>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col gap-8">
              ...
              <Button size="lg" className="w-fit px-8 mt-4 shadow-xl shadow-primary/20">
        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            <div className="bg-emerald-950 rounded-[40px] p-8 md:p-16 text-white overflow-hidden relative">
              {/* Decor */}
              <div className="absolute bottom-0 right-0 size-80 bg-primary/10 rounded-full translate-y-1/2 translate-x-1/2 blur-3xl" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                <div className="flex flex-col gap-10">
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="flex gap-6">
                      <MapPin className="size-8 text-primary/60 shrink-0" />
                      <div className="flex flex-col">
                        <span className="text-sm font-black uppercase tracking-widest text-primary/60 mb-1">Our Location</span>
                    ...
                    <div className="flex gap-6">
                      <Phone className="size-8 text-primary/60 shrink-0" />
                      <div className="flex flex-col">
                        <span className="text-sm font-black uppercase tracking-widest text-primary/60 mb-1">Call Us</span>
                        <p className="text-lg font-medium opacity-90">+880 1814-214220</p>
                      </div>
                    </div>

                    <div className="flex gap-6">
                      <Mail className="size-8 text-primary/60 shrink-0" />
                      <div className="flex flex-col">
                        <span className="text-sm font-black uppercase tracking-widest text-primary/60 mb-1">Email Support</span>
                  ...
                  <div className="flex flex-wrap gap-4 mt-4">
                    <Button className="bg-primary text-white hover:bg-primary/90 px-8 py-7 text-lg font-black">
                      Get Directions
                    </Button>
                ...
                <div className="relative aspect-video lg:aspect-auto rounded-3xl overflow-hidden bg-emerald-900/50 border border-white/10 shadow-2xl">
                   ...
                   <div className="absolute inset-0 flex items-center justify-center text-primary font-black text-2xl uppercase tracking-[0.3em] opacity-20">
                     Interactive Map
                   </div>
                   <Image 
                   ...
                   <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                     <div className="size-8 rounded-full bg-primary flex items-center justify-center animate-bounce shadow-lg shadow-primary/50">
                       <MapPin className="size-5 text-white" />
                     </div>
                     <div className="size-20 rounded-full bg-primary/20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-ping" />
                   </div>
                </div>
              </div>
            </div>
