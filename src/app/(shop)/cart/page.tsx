 ...
 * @file page.tsx
 * @path /cart
 * @description Shopping cart page. Reads from localStorage-backed CartContext.
 *              Shows line items, cost breakdown, and proceed to checkout action.
 *
...
/** Shopping cart page — reads live cart from CartContext. */
          ...
          {isEmpty ? (
            <div className="py-12 bg-white rounded-3xl border border-gray-100 shadow-sm">
              <EmptyState
                ...
                cta={<Link href="/products"><Button variant="primary" size="lg" className="w-full">Start Shopping</Button></Link>}
              />
            </div>
          ) : (
              ...
              <div className="lg:col-span-8 flex flex-col gap-4">
                {items.map((item) => (
                  <CartItem
                    ...
                    onQuantityChange={(q) => updateQty(item.productId, q)}
