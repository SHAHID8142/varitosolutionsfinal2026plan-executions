              ...
              {ORDER.items.map((item) => (
                <div key={item.id} className="p-8 flex items-center gap-6 hover:bg-gray-50/50 transition-colors">
                  ...
                  <div className="flex-1 flex flex-col gap-1">
                    <span className="text-[10px] font-black text-primary uppercase tracking-widest">{item.sku}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <section className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <Button onClick={handleUpdateStatus} loading={isUpdating} className="h-14 rounded-2xl font-black uppercase tracking-widest text-xs shadow-lg shadow-primary/10">
                  Save Status
                </Button>
              </div>
            </section>
          ...
          <section className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm flex flex-col gap-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-6 relative z-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href={`tel:${ORDER.customer.phone}`} className="text-sm font-black text-gray-900 hover:text-primary transition-colors">{ORDER.customer.phone}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href={`mailto:${ORDER.customer.email}`} className="text-sm font-bold text-gray-700 hover:text-primary transition-colors">{ORDER.customer.email}</a>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-[32px] bg-gray-950 text-white flex justify-between items-center relative z-10">
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-black uppercase tracking-[0.2em] text-primary/60">Total Orders</span>
              </div>
              ...
              <div className="flex flex-col items-end">
                ...
                <span className="text-[8px] font-bold text-primary/60 uppercase tracking-widest mt-1">Since {ORDER.customer.joinedDate}</span>
              </div>
            </div>
          </section>
