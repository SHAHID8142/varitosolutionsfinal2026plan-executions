/**
 * @file PathaoIcon.tsx
 * @description Official Pathao logo component.
 *
...
export function PathaoIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="107" height="41" viewBox="0 0 107 41" className={className}>
